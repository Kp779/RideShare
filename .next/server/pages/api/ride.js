...
/* harmony export */ });
/* harmony import */ var _utils_connectDB__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4271);
/* harmony import */ var _models_schema__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4879);
...
async function handler(req, res) {
    if (req.method === "POST") {
        try {
            console.log("Trying");
            const { name , aadhar , carno , lisence  } = req.body;
            const existingUser = await _models_schema__WEBPACK_IMPORTED_MODULE_1__/* ["default"].findOne */ .Z.findOne({
                email
            });
            if (existingUser) {
            ...
            const newUser = new _models_schema__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z({
                name,
                email,
                blockchainAddress
            });
...
var __webpack_exports__ = (__webpack_exec__(3997));
