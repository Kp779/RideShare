...
function FocusTrapPopover2() {
  ...
  return (
    <>
      <Button
        style={{ fontSize: "1.3rem", padding: "1.7rem" }}  colorScheme="blue"  variant='outline' onClick={onOpen}>sign up
     </Button>
      ...
      >
        ...
        <ModalContent style={{ padding: "1.7rem" }}>
          ...
          <ModalFooter>
            ...
            <Button
              style={{ fontSize: "1.5rem", padding: "1.7rem" }}  variant='outline' colorScheme="blue"
              onClick={onClose}
            >
              Close
            </Button>
...
export default FocusTrapPopover2;
