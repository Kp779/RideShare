...
const App = () => {
  ...
  useEffect(() => {
    ...
    axios.get('http://localhost:5000/api/employees').then((response) => setEmployees(response.data));
  }, []);
  ...
  const handleAddEmployee = () => {
    axios.post('http://localhost:5000/api/employees', newEmployee).then((response) => {
